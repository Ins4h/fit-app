...
const MyComponent = () => {
  ...
  return (
    <ToggleButton.Row onValueChange={value => setValue(value)} value={value}  style = {{justifyContent: 'center', backgroundColor: 'rgb(56,56,56)', borderRadius: 6}}>
      <ToggleButton icon={ () => <View><Text>Deadlift classic</Text></View>} title="Beginner" value="beginner" style = {{ width: '55%', height: 50, color: 'black'}} color='black'>abc</ToggleButton>
