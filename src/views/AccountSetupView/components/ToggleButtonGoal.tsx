...
const ToggleButtonGoal: React.FC = () => {
  ...
  return (
    <ToggleButton.Row onValueChange={value => setValue(value)} value={value} style = {{justifyContent: 'center', backgroundColor: 'rgb(77,197,82)', borderRadius: 6}}>
      <ToggleButton icon={ () => <View><Text>Maintaining</Text></View>} value="beginner" style = {{ width: '30%', height: 50}} color='black'>abc</ToggleButton>
...
export default ToggleButtonGoal;
